...
<section id="locations">
  ...
  <div class="card-container">
    <div class="card">Beachfront resorts with sustainable water management practices.</div>
    <div class="card">Underwater museums and aquariums showcasing aquatic ecosystems.</div>
    <div class="card">Lakeside eco-retreats promoting awareness about water conservation.</div>
  </div>
</section>
